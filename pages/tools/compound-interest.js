    ...
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
          <input type="number" className="input" placeholder="Principal Amount" value={principal} onChange={e => setPrincipal(e.target.value)} />
          <input type="number" className="input" placeholder="Annual Interest Rate (%)" value={rate} onChange={e => setRate(e.target.value)} />
          <input type="number" className="input" placeholder="Years" value={years} onChange={e => setYears(e.target.value)} />
        ...
        {result && (
          <div className="mt-8 bg-green-50 p-4 rounded shadow">
            ...
            <p className="text-gray-800">Future Value: <strong>{currency} {result}</strong></p>
